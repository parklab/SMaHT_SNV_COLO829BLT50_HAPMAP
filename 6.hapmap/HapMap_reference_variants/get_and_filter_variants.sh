...
### REQUIRED INPUT: ----------------------------------------------------------------------------------------------------------------------------------------
# Directory to store reference variant calls in
# Path to human reference genome GRCh38 without alt contigs
# Path to confident regions for these cells lines, obtained with "get_confident_regions.sh"
